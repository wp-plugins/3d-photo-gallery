    ...
    jQuery('.upload_image_button').live('click', function( event ){
        ...
        la_photo_gallery.on( 'select', function() {
            ...
            selection.map( function( attachment ) {
                ...
                jQuery('.selected_images').append('<div><img src="'+attachment.url+'"><span class="dashicons dashicons-dismiss"></span><textarea placeholder="Description" name="" id="desc"></textarea></div>');
